...
<!dashboard-->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="vendordash.jsp"><i class="fa fa-home home_1"></i></a> / <span>User Dashboard</span>
...
%> 
        ...
        <%
                  ...
                  java.util.ArrayList<vendor_Pojo> data=dao.FetchVendorQuery(email1);
                  for(vendor_Pojo pojo:data)
                  {
                  
                       
                        ResultSet rs=stmt.executeQuery("select * from query where sc_name='"+pojo.getCategory()+"'");
				...
				<form action="getresponse.jsp" method="post">
					
                                    <div class="submit-ad main-grid-border">
		<div class="container">
                    <center><h2 class="w3-head">Post Your Response</h2></center>
			<div class="post-ad-form">
				<form method="GET">
                                   <div class="clearfix">
                                     <label>Your Vendor ID is-</label>
                                  <br>
                                                    <%
                  String email2=(String)session.getAttribute("email");
                  Admin_Dao dao1=new Admin_Dao();
                  java.util.ArrayList<vendor_Pojo> data1=dao1.FetchVendorid(email2);
                  for(vendor_Pojo pojo:data1)
                  {
                  %>
                  
                                  <input type="number" placeholder="<%=pojo.getVid()%>" value="<%=pojo.getVid()%>" name="vid" readonly>
                  ...
                  <% } %>
					...
					<div class="clearfix"></div>
                                           ...
                                           <label>Enter Query ID to respond to</label>
                                        <input type="number" placeholder="Enter Query id" name="qid">
                                        <br>
                                        <br>
                  ...
                  java.util.ArrayList<vendor_Pojo> data2=dao2.FetchVendorQuery(email3);
                  for(vendor_Pojo pojo2:data2)
                  {
                      
                  %>
                  
                   <input type="text" placeholder="<%=pojo2.getCategory()%>" value="<%=pojo2.getCategory()%>" name="" readonly>
                                                        <% } %>
                                                        <br>
                                                        
                                                        
                                                       <div class="clearfix"></div>
                                                        <label>Enter User ID to respond to</label>
                                        <input type="number" placeholder="Enter uid" name="uid">
                                        <br>
                                        <br>
					...
					<div class="clearfix"></div>
					<label>Add Description for Response </label>
                                        <br>
					<textarea type="text" placeholder="Few lines about your Product" required="" name="res_text"></textarea>
					<div class="clearfix"></div>    
                  ...
                  Admin_Dao dao3=new Admin_Dao();
                  java.util.ArrayList<vendor_Pojo> data3=dao3.FetchVendorcon(email4);
                  for(vendor_Pojo pojo3:data3)
                  {
                  %>
                  
                                  <input type="text" placeholder="<%=pojo3.getContact()%>" value="<%=pojo3.getContact()%>" name="vcontact">
