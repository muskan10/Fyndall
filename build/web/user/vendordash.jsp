...
<!dashboard-->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.jsp"><i class="fa fa-home home_1"></i></a> / <span>Vendor Dashboard</span>
                            <i class="fa fa-user" style="margin-left: 300px;"></i> 
                            <span> <a>  
                                <%   
...
%>  </a></span>
                            <a href="index.jsp"><i class=" fa fa-sign-out" style="margin-left:200px;"></i> Sign Out</a></span>
    ...
    <!--content-->                        
		<div class="col-md-5 page_1" style="margin-left: 50px">
			<div class="list-group list-group-alternate" style="margin-left: 50px"> 
				<a href="vendorinbox.jsp" class="list-group-item" ><span class="badge"></span> <i class="ti ti-email"></i> Inbox </a> 
                                <br>
				
                                <a href="queryresponded.jsp" class="list-group-item"><span class="badge badge-danger"></span> <i class="ti ti-bell"></i> Queries you responded to </a> 
                                <br>
                        </div>
	   </div>
