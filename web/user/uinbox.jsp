...
<!dashboard-->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="udash.jsp"><i class="fa fa-home home_1"></i></a> / <span>User Dashboard</span>
            ...
            <div class="table-responsive">
                <table class="table">
                  ...
                  for(User_Pojo pojo:data)
                  {
                        ...
                        ResultSet rs=stmt.executeQuery("select * from query where uid='"+pojo.getUid()+"'");
