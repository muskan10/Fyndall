...
%> 
    ...
    <div class="clearfix"></div>
        ...
        <%
                  ...
                  java.util.ArrayList<User_Pojo> data=dao.FetchUserQuery(email1);
                  for(User_Pojo pojo:data)
                  {
                  
                       
                        ResultSet rs=stmt.executeQuery("select * from query_response where uid='"+pojo.getUid()+"' ORDER BY qresid DESC");
