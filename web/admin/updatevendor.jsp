...
<html>
    ...
    <body>
        <%
            ...
            if(dao.Updatevendor(request.getParameter("hf"),request.getParameter("vname"),request.getParameter("vemail"),request.getParameter("vpass"),request.getParameter("vcontact"),request.getParameter("vprofile"))>0){
