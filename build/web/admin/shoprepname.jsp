          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                  ...
                  java.util.ArrayList<shop_Pojo> data=dao.FetchShopCat();
                ...
                <tr class="gradeX">
                  ...
                  <td><%=pojo.getVid()%></td>
                  <td><a href="editshop.jsp?shop_cat=<%=pojo.getShop_cat()%>"><img src="image/edit.png" width="30px" height="30px"/></a></td>
